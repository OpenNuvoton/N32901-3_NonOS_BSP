...
#define UVC_PH_Preview			0x80
#define UVC_PH_Snapshot			0xA0
...
/* Processing Unit Control Selectors */
#define	PU_BACKLIGHT_COMPENSATION_MIN				0
#define	PU_BACKLIGHT_COMPENSATION_MAX				70
#define	PU_BACKLIGHT_COMPENSATION_DEF				7
#define	PU_BRIGHTNESS_MIN							-10
#define	PU_BRIGHTNESS_MAX							10
#define	PU_BRIGHTNESS_DEF							1
#define	PU_CONTRAST_MIN								0
#define	PU_CONTRAST_MAX								20
#define	PU_CONTRAST_DEF								2
#define	PU_HUE_MIN									-30
#define	PU_HUE_MAX									30
#define	PU_HUE_DEF									0
#define	PU_SATURATION_MIN							0
#define	PU_SATURATION_MAX							40
#define	PU_SATURATION_DEF							4
#define	PU_SHARPNESS_MIN							0
#define	PU_SHARPNESS_MAX							50
#define	PU_SHARPNESS_DEF							5
#define	PU_GAMMA_MIN								1
#define	PU_GAMMA_MAX								5
#define	PU_GAMMA_DEF								3
#define PU_POWER_LINE_FREQUENCY_MIN					0
#define PU_POWER_LINE_FREQUENCY_MAX					2
#define PU_POWER_LINE_FREQUENCY_DEF					2
