...
#define USB_PID		0x1111		/* Product ID */

#define     MAX_PACKET_SIZE_HS     0x3E8
#define     MAX_PACKET_SIZE_FS     0x3E8

volatile int max_packet_size = 0x3E8;
...
{
	0x2E, 0x03,
	'M', 0x00, 'B', 0x00, 'P', 0x00, '3', 0x00, '6', 0x00, ' ', 0x00, ' ', 0x00, ' ', 0x00,
...
VOID UVC_DMACompletion(VOID)
{
	...
	outpw(DMA_CTRL_STS, 0x00000080);
    outpw(DMA_CTRL_STS, 0x00000000);   	
	...
	{
		if(usbdInfo.AlternateFlag == 0 || usbdInfo.u32VbusStatus == 0)		
		{
...
VOID uvcdInit(PFN_UVCD_PUCONTROL_CALLBACK* callback_func)
{
	...
	uvcInfo.IsoMaxPacketSize[0] = 0x000003E8;
	uvcInfo.IsoMaxPacketSize[1] = 0x000003E8; 
	uvcInfo.IsoMaxPacketSize[2] = 0x000003E8; 	
	usbdInfo.usbdMaxPacketSize = uvcInfo.IsoMaxPacketSize[1];
	
	//Initialize Video Capture Filter Control Value               	
    uvcInfo.CapFilter.POWER_LINE_FREQUENCY = uvcPuInfo.PU_POWER_LINE_FREQUENCY_DEF;
	uvcInfo.CapFilter.Brightness = uvcPuInfo.PU_BRIGHTNESS_DEF;
	uvcInfo.CapFilter.Contrast = uvcPuInfo.PU_CONTRAST_DEF;
	uvcInfo.CapFilter.Hue = uvcPuInfo.PU_HUE_DEF;
	uvcInfo.CapFilter.Saturation = uvcPuInfo.PU_SATURATION_DEF;
	uvcInfo.CapFilter.Sharpness = uvcPuInfo.PU_SHARPNESS_DEF;
	uvcInfo.CapFilter.Gamma = uvcPuInfo.PU_GAMMA_DEF;
	uvcInfo.CapFilter.Backlight = uvcPuInfo.PU_BACKLIGHT_COMPENSATION_DEF;
